<script>
	...
	import { FluidForm, TextInput, PasswordInput, Loading, Button, Checkbox, InlineNotification, ToastNotification } from 'carbon-components-svelte';
	...
	const register = async () => {
		if(password != password_2) return (error = 'Password mismatch! Make sure to type the same one.')
...
<div class="">
	<div class="w-2/4 mx-auto">
		...
		/>
<div class="py-2">By signing up, you agree to Anomia's Terms of Use, Privacy Policy and Cookie Policy</div>		</FluidForm>
		<div class="flex justify-between">
			<Button on:click={() => register()} class="w-full border border-white hover:border-transparent"
				>Register</Button
			>
		</div>
	</div>
